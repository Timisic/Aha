...
test("isExcludedCandidatePath keeps regular notes and near-miss names", () => {
  assert.equal(isExcludedCandidatePath("个人复盘/reviews/week/2026-W22.md"), false);
  assert.equal(isExcludedCandidatePath("Categories/Evergreen/反馈是经验差距的显影装置.md"), false);
...
test("AHA_EXCLUDED_FOLDERS extends the default list", () => {
  ...
  try {
    ...
    assert.equal(isExcludedCandidatePath("BOOK/Course/人机交互课程心得.md", folders), true);
  } finally {
