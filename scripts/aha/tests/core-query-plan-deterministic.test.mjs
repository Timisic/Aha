...
//
// scripts/aha/tests/query-plan.test.mjs keeps its full coverage as an
// integration test of scripts/aha/query-plan.mjs's LLM-adapter surface
// (generateQueryPlanWithAdapter, resolveQmdQueriesForCase), which now calls
// into these same core functions internally — nothing was dropped there.
