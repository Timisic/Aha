...
function usage() {
  return [
    ...
    "",
    "Options:",
    "  --vault-root <path>   Vault root to strip. Default: $AHA_BENCH_VAULT_ROOT or /Users/hong/Obsidian Notes",
...
function parseArgs(argv) {
  const options = {
    files: [],
    vaultRoot: process.env.AHA_BENCH_VAULT_ROOT || "/Users/hong/Obsidian Notes",
    check: false,
  };
